(function(g){var window=this;'use strict';var VUa=function(a,b){return g.Pe(a,b)},WUa=function(a,b){b=b instanceof g.Qf?b:g.Yf(b,/^data:image\//i.test(b));
...
g.ml(a.u,b,c)},XUa=function(a){if(a===g.cp)throw Error("ES6 Iteration protocol does NOT adjust control flow when StopIteration is thrown from callback helper functions. If your code relies on this behavior, consider throwing a different error and catching it to terminate iteration.");
throw a;},YUa=function(a){if(a instanceof g.ap)return a;
...
return c}throw Error("Not implemented");},ZUa=function(a,b,c){if(g.Na(a))try{g.sc(a,b,c)}catch(e){XUa(e)}else for(a=YUa(a);;){var d=void 0;
try{d=a.Dj()}catch(e){if(e===g.cp)break;throw e;}try{b.call(c,d,void 0,a)}catch(e){XUa(e)}}},$Ua=function(a,b){var c=[];
ZUa(b,function(d){try{var e=g.ks.prototype.u.call(this,d,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}void 0===e?c.push(d):g.kfa(e)&&c.push(d)},a);
return c},aVa=function(a,b){$Ua(a,b).forEach(function(c){g.ks.prototype.remove.call(this,c)},a)},bVa=function(a){if(a.xa){if(a.xa.locationOverrideToken)return{locationOverrideToken:a.xa.locationOverrideToken};
if(null!=a.xa.latitudeE7&&null!=a.xa.longitudeE7)return{latitudeE7:a.xa.latitudeE7,longitudeE7:a.xa.longitudeE7}}return null},cVa=function(a,b){g.Wb(a,b)||a.push(b)},R6=function(a){var b=0,c;
for(c in a)b++;return b},dVa=function(a){try{return g.B.JSON.parse(a)}catch(b){}a=String(a);
if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);},S6=function(a){if(g.B.JSON)try{return g.B.JSON.parse(a)}catch(b){}return dVa(a)},eVa=function(a,b,c,d){var e=new g.Qk(null,void 0);
...
a.user||"",this.avatar=a.userAvatarUri||"",this.obfuscatedGaiaId=a.obfuscatedGaiaId||"",this.theme=a.theme||"u",fVa(this,a.capabilities||""),gVa(this,a.experiments||""),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN",a=a.deviceInfo)&&(a=JSON.parse(a),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",
this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.clientName=a.clientName?a.clientName.toUpperCase():"UNKNOWN_INTERFACE",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN")},fVa=function(a,b){a.capabilities.clear();
g.Cp(b.split(","),g.Ra(VUa,hVa)).forEach(function(c){a.capabilities.add(c)})},gVa=function(a,b){a.experiments.clear();
b.split(",").forEach(function(c){a.experiments.add(c)})},V6=function(a){a=a||{};
this.name=a.name||"";this.id=a.id||a.screenId||"";this.token=a.token||a.loungeToken||"";this.uuid=a.uuid||a.dialId||"";this.idType=a.screenIdType||"normal"},W6=function(a,b){return!!b&&(a.id==b||a.uuid==b)},iVa=function(a){return{name:a.name,
screenId:a.id,loungeToken:a.token,dialId:a.uuid,screenIdType:a.idType}},jVa=function(a){return new V6(a)},kVa=function(a){return Array.isArray(a)?g.pn(a,jVa):[]},X6=function(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+((a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+",idType:"+a.idType+"}"):"null"},Y6=function(a){return Array.isArray(a)?"["+g.pn(a,X6).join(",")+"]":"null"},Z6=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(a){var b=16*Math.random()|0;
return("x"==a?b:b&3|8).toString(16)})},lVa=function(a){return g.pn(a,function(b){return{key:b.id,
name:b.name}})},$6=function(a,b){return g.Tb(a,function(c){return c||b?!c!=!b?!1:c.id==b.id:!0})},a7=function(a,b){return g.Tb(a,function(c){return W6(c,b)})},mVa=function(){var a=(0,g.oy)();
a&&aVa(a,a.i.Kg(!0))},b7=function(){var a=g.ry("yt-remote-connected-devices")||[];
g.pc(a);return a},nVa=function(a){if(g.Xb(a))return[];
var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return g.pn(a,function(d,e){return 0==e?d:d.substring(c.length)})},oVa=function(a){g.qy("yt-remote-connected-devices",a,86400)},d7=function(){if(c7)return c7;
...
g.Wb(a,b);g.ty()&&g.rc(a,b);a=nVa(a);if(g.Xb(a))try{g.Bia("remote_sid")}catch(c){}else try{g.qu("remote_sid",a.join(","),-1)}catch(c){}},pVa=function(){return g.ry("yt-remote-session-browser-channel")},qVa=function(){return g.ry("yt-remote-local-screens")||[]},rVa=function(){g.qy("yt-remote-lounge-token-expiration",!0,86400)},sVa=function(a){5<a.length&&(a=a.slice(a.length-5));
var b=g.pn(qVa(),function(d){return d.loungeToken}),c=g.pn(a,function(d){return d.loungeToken});
g.qn(c,function(d){return!g.Wb(b,d)})&&rVa();
g.qy("yt-remote-local-screens",a,31536E3)},tVa=function(a,b){g.qy("yt-remote-session-browser-channel",a);
g.qy("yt-remote-session-screen-id",b);a=b7();b=d7();g.Wb(a,b)||a.push(b);oVa(a);e7()},f7=function(a){a||(g.sy("yt-remote-session-screen-id"),g.sy("yt-remote-session-video-id"));
e7();a=b7();g.$b(a,d7());oVa(a)},uVa=function(){if(!g7){var a=g.us();
a&&(g7=new g.hs(a))}},vVa=function(){uVa();
return g7?!!g7.get("yt-remote-use-staging-server"):!1},h7=function(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);
return a?parseInt(a[1],10):0},wVa=function(a){return!!document.currentScript&&(-1!=document.currentScript.src.indexOf("?"+a)||-1!=document.currentScript.src.indexOf("&"+a))},xVa=function(){return"function"==typeof window.__onGCastApiAvailable?window.__onGCastApiAvailable:null},i7=function(a){a.length?yVa(a.shift(),function(){i7(a)}):j7()},zVa=function(a){return"chrome-extension://"+a+"/cast_sender.js"},yVa=function(a,b,c){var d=document.createElement("script");
d.onerror=b;c&&(d.onload=c);g.kk(d,g.Yr(a));(document.head||document.documentElement).appendChild(d)},AVa=function(){var a=h7(),b=[];
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},j7=function(){var a=xVa();
a&&a(!1,"No cast extension found")},k7=function(){if(BVa){var a=2,b=xVa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;yVa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",j7,c)}},CVa=function(){k7();
var a=AVa();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");i7(a)},EVa=function(){k7();
var a=AVa();a.push.apply(a,g.ma(DVa.map(zVa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");i7(a)},l7=function(a,b,c){g.E.call(this);
...
return g.B.setTimeout(function(){a()},b)},r7=function(a){q7.dispatchEvent(new FVa(q7,a))},FVa=function(a,b){g.ue.call(this,"statevent",a);
this.stat=b},s7=function(a,b,c,d){this.i=a;
this.B=b;this.S=c;this.K=d||1;this.u=45E3;this.C=new g.nl(this);this.I=new g.Xh;this.I.setInterval(250)},HVa=function(a,b,c){a.Pt=1;
a.cn=P6(b.clone());a.Aq=c;a.D=!0;GVa(a,null)},t7=function(a,b,c,d,e){a.Pt=1;
a.cn=P6(b.clone());a.Aq=null;a.D=c;e&&(a.RN=!1);GVa(a,d)},GVa=function(a,b){a.Ct=Date.now();
u7(a);a.Ko=a.cn.clone();Q6(a.Ko,"t",a.K);a.DB=0;a.Mf=a.i.wD(a.i.vx()?b:null);0<a.pC&&(a.RA=new m7((0,g.D)(a.VO,a,a.Mf),a.pC));a.C.Ra(a.Mf,"readystatechange",a.IQ);b=a.Zo?g.We(a.Zo):{};a.Aq?(a.BB="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.Mf.send(a.Ko,a.BB,a.Aq,b)):(a.BB="GET",a.RN&&!g.Yg&&(b.Connection="close"),a.Mf.send(a.Ko,a.BB,null,b));a.i.Ej(1)},JVa=function(a,b){var c=a.DB,d=b.indexOf("\n",c);
if(-1==d)return v7;c=Number(b.substring(c,d));if(isNaN(c))return IVa;d+=1;if(d+c>b.length)return v7;b=b.substr(d,c);a.DB=d+c;return b},LVa=function(a,b){a.Ct=Date.now();
u7(a);var c=b?window.location.hostname:"";a.Ko=a.cn.clone();g.hl(a.Ko,"DOMAIN",c);g.hl(a.Ko,"t",a.K);try{a.Rj=new ActiveXObject("htmlfile")}catch(m){w7(a);a.Tm=7;r7(22);x7(a);return}var d="<html><body>";if(b){var e="";for(b=0;b<c.length;b++){var f=c.charAt(b);if("<"==f)f=e+"\\x3c";else if(">"==f)f=e+"\\x3e";else{if(f in y7)f=y7[f];else if(f in KVa)f=y7[f]=KVa[f];else{var h=f.charCodeAt(0);if(31<h&&127>h)var l=f;else{if(256>h){if(l="\\x",16>h||256<h)l+="0"}else l="\\u",4096>h&&(l+="0");l+=h.toString(16).toUpperCase()}f=
...
a.u;
MVa(a,a.u)},MVa=function(a,b){if(null!=a.du)throw Error("WatchDog timer not null");
...
g.re(a.RA);a.RA=null;a.I.stop();g.pl(a.C);if(a.Mf){var b=a.Mf;a.Mf=null;b.abort();b.dispose()}a.Rj&&(a.Rj=null)},A7=function(a,b){try{a.i.VM(a,b),a.i.Ej(4)}catch(c){}},OVa=function(a,b,c,d,e){if(0==d)c(!1);
else{var f=e||0;d--;NVa(a,b,function(h){h?c(!0):g.B.setTimeout(function(){OVa(a,b,c,d,f)},f)})}},NVa=function(a,b,c){var d=new Image;
...
WUa(d,a)},B7=function(a){a.onload=null;
a.onerror=null;a.onabort=null;a.ontimeout=null},PVa=function(a){this.i=a;
this.u=new o7},QVa=function(a){var b=C7(a.i,a.Uu,"/mail/images/cleardot.gif");
P6(b);OVa(b.toString(),5E3,(0,g.D)(a.wR,a),3,2E3);a.Ej(1)},E7=function(a){var b=a.i.X;
if(null!=b)r7(5),b?(r7(11),D7(a.i,a,!1)):(r7(12),D7(a.i,a,!0));else if(a.uh=new s7(a,void 0,void 0,void 0),a.uh.Zo=a.qC,b=a.i,b=C7(b,b.vx()?a.Iu:null,a.rC),r7(5),!g.Jc||g.Bc(10))Q6(b,"TYPE","xmlhttp"),t7(a.uh,b,!1,a.Iu,!1);else{Q6(b,"TYPE","html");var c=a.uh;a=!!a.Iu;c.Pt=3;c.cn=P6(b.clone());LVa(c,a)}},F7=function(a,b,c){this.i=1;
this.u=[];this.C=[];this.D=new o7;this.S=a||null;this.X=null!=b?b:null;this.I=c||!1},RVa=function(a,b){this.i=a;
this.map=b;this.context=null},SVa=function(a,b,c,d){g.ue.call(this,"timingevent",a);
this.size=b;this.jx=d},TVa=function(a){g.ue.call(this,"serverreachability",a)},WVa=function(a){UVa(a);
if(3==a.i){var b=a.xw++,c=a.Xy.clone();g.hl(c,"SID",a.B);g.hl(c,"RID",b);g.hl(c,"TYPE","terminate");G7(a,c);b=new s7(a,a.B,b,void 0);b.Pt=2;b.cn=P6(c.clone());WUa(new Image,b.cn.toString());b.Ct=Date.now();u7(b)}VVa(a)},XVa=function(a){a.WR(1,0);
a.Xy=C7(a,null,a.sC);H7(a)},UVa=function(a){a.jn&&(a.jn.abort(),a.jn=null);
a.Je&&(a.Je.cancel(),a.Je=null);a.Kl&&(g.B.clearTimeout(a.Kl),a.Kl=null);I7(a);a.Ug&&(a.Ug.cancel(),a.Ug=null);a.Dn&&(g.B.clearTimeout(a.Dn),a.Dn=null)},YVa=function(a,b){if(0==a.i)throw Error("Invalid operation: sending map when state is closed");
a.u.push(new RVa(a.AT++,b));2!=a.i&&3!=a.i||H7(a)},ZVa=function(a){var b=0;
a.Je&&b++;a.Ug&&b++;return b},H7=function(a){a.Ug||a.Dn||(a.Dn=p7((0,g.D)(a.aN,a),0),a.xs=0)},aWa=function(a,b){if(1==a.i){if(!b){a.xw=Math.floor(1E5*Math.random());
b=a.xw++;var c=new s7(a,"",b,void 0);c.Zo=a.dk;var d=J7(a),e=a.Xy.clone();g.hl(e,"RID",b);g.hl(e,"CVER","1");G7(a,e);HVa(c,e,d);a.Ug=c;a.i=2}}else 3==a.i&&(b?$Va(a,b):0==a.u.length||a.Ug||$Va(a))},$Va=function(a,b){if(b)if(6<a.wp){a.u=a.C.concat(a.u);
a.C.length=0;var c=a.xw-1;b=J7(a)}else c=b.S,b=b.Aq;else c=a.xw++,b=J7(a);var d=a.Xy.clone();g.hl(d,"SID",a.B);g.hl(d,"RID",c);g.hl(d,"AID",a.Ss);G7(a,d);c=new s7(a,a.B,c,a.xs+1);c.Zo=a.dk;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.Ug=c;HVa(c,d,b)},G7=function(a,b){a.Nf&&(a=a.Nf.uK())&&g.De(a,function(c,d){g.hl(b,d,c)})},J7=function(a){var b=Math.min(a.u.length,1E3),c=["count="+b];
...
return c.join("&")},bWa=function(a){a.Je||a.Kl||(a.K=1,a.Kl=p7((0,g.D)(a.ZM,a),0),a.Sr=0)},K7=function(a){if(a.Je||a.Kl||3<=a.Sr)return!1;
a.K++;a.Kl=p7((0,g.D)(a.ZM,a),cWa(a,a.Sr));a.Sr++;return!0},D7=function(a,b,c){a.zB=c;
a.ek=b.xl;a.I||XVa(a)},I7=function(a){null!=a.Ep&&(g.B.clearTimeout(a.Ep),a.Ep=null)},cWa=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},L7=function(a,b){if(2==b||9==b){var c=null;
a.Nf&&(c=null);var d=(0,g.D)(a.LX,a);c||(c=new g.Qk("//www.google.com/images/cleardot.gif"),P6(c));NVa(c.toString(),1E4,d)}else r7(2);dWa(a,b)},dWa=function(a,b){a.i=0;
a.Nf&&a.Nf.HJ(b);VVa(a);UVa(a)},VVa=function(a){a.i=0;
...
if(""!=d.i)b&&g.Sk(d,b+"."+d.i),g.Tk(d,d.B);else{var e=window.location;d=eVa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.Av&&g.De(a.Av,function(f,h){g.hl(d,h,f)});
g.hl(d,"VER",a.wp);G7(a,d);return d},eWa=function(){},fWa=function(){this.i=[];
...
e=void 0===e?!1:e;this.xa=a;this.I=b;this.B=new g.gs;this.u=new M7(this.pX,this);this.i=null;this.Z=!1;this.D=null;this.X="";this.S=this.C=0;this.K=[];this.Aa=c;this.oa=d;this.Ba=e},hWa=function(a){return{firstTestResults:[""],
secondTestResults:!a.i.zB,sessionId:a.i.B,arrayId:a.i.Ss}},iWa=function(a,b){a.S=b||0;
a.u.stop();O7(a);a.i&&(3==a.i.getState()&&aWa(a.i),WVa(a.i));a.S=0},P7=function(a){return!!a.i&&3==a.i.getState()},O7=function(a){if(a.i){var b=a.oa(),c=a.i.dk||{};
...
method:"POST",context:a,timeout:5E3,withCredentials:!1,onSuccess:g.Ra(a.C,d,!0),onError:g.Ra(a.B,e),onTimeout:g.Ra(a.D,e)};c&&(a.postParams=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.hu(b,a)},mWa=function(){var a=jWa;
kWa();T7.push(a);lWa()},U7=function(a,b){kWa();
var c=nWa(a,String(b));g.Xb(T7)?oWa(c):(lWa(),g.sc(T7,function(d){d(c)}))},kWa=function(){T7||(T7=g.Ja("yt.mdx.remote.debug.handlers_")||[],g.Ia("yt.mdx.remote.debug.handlers_",T7,void 0))},oWa=function(a){var b=(V7+1)%50;
V7=b;W7[b]=a;X7||(X7=49==b)},lWa=function(){var a=T7;
if(W7[0]){var b=X7?V7:-1;do{b=(b+1)%50;var c=W7[b];g.sc(a,function(d){d(c)})}while(b!=V7);
W7=Array(50);V7=-1;X7=!1}},nWa=function(a,b){var c=(Date.now()-pWa)/1E3;
c.toFixed&&(c=c.toFixed(3));var d=[];d.push("[",c+"s","] ");d.push("[","yt.mdx.remote","] ");d.push(a+": "+b,"\n");return d.join("")},Y7=function(a){g.Q.call(this);
this.I=a;this.screens=[]},qWa=function(a,b){var c=a.get(b.uuid)||a.get(b.id);
if(c)return a=c.name,c.id=b.id||c.id,c.name=b.name,c.token=b.token,c.uuid=b.uuid||c.uuid,c.name!=a;a.screens.push(b);return!0},rWa=function(a,b){var c=a.screens.length!=b.length;
a.screens=g.Cp(a.screens,function(f){return!!$6(b,f)});
for(var d=0,e=b.length;d<e;d++)c=qWa(a,b[d])||c;return c},sWa=function(a,b){var c=a.screens.length;
...
this.u=a;this.i=NaN;$7(this);this.info("Initializing with "+Y6(this.screens))},tWa=function(a){if(a.screens.length){var b=g.pn(a.screens,function(d){return d.id}),c=R7(a.u,"/pairing/get_lounge_token_batch");
S7(a.u,c,{screen_ids:b.join(",")},(0,g.D)(a.vS,a),(0,g.D)(a.uS,a))}},$7=function(a){if(g.O("deprecate_pair_servlet_enabled"))return rWa(a,[]);
var b=kVa(qVa());b=g.Cp(b,function(c){return!c.uuid});
return rWa(a,b)},b8=function(a,b){sVa(g.pn(a.screens,iVa));
b&&rVa()},d8=function(a,b){g.Q.call(this);
...
else{c=g.Ne(b);for(var d=0,e=c.length;d<e;++d)if(!a.i[c[d]]){c=!1;break a}c=!0}c||(c8("Updated online screens: "+g.zi(a.i)),a.i=b,a.ea("screenChange"));uWa(a)},g8=function(a){isNaN(a.B)||g.Ot(a.B);
a.B=g.Mt((0,g.D)(a.gG,a),0<a.C&&a.C<g.Ta()?2E4:1E4)},c8=function(a){U7("OnlineScreenService",a)},vWa=function(a){var b={};
g.sc(a.I(),function(c){c.token?b[c.token]=c.id:this.ke("Requesting availability of screen w/o lounge token.")});
return b},uWa=function(a){a=g.Ne(g.Ee(a.i,function(b){return b}));
...
Y7.call(this,"ScreenService");this.C=a;this.K=b;this.i=this.u=null;this.B=[];this.D={};wWa(this)},yWa=function(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);
c||(c=a.D[b]);var h=a.Ih(),l=c?a7(h,c):null;c&&(a.K||l)||(l=a7(h,b));if(l){l.uuid=b;var m=i8(a,l);e8(a.i,m,function(n){e(n?m:null)})}else c?xWa(a,c,(0,g.D)(function(n){var p=i8(this,new V6({name:d,
screenId:c,loungeToken:n,dialId:b||""}));e8(this.i,p,function(r){e(r?p:null)})},a),f):e(null)},zWa=function(a,b){for(var c=0,d=a.screens.length;c<d;++c)if(a.screens[c].name==b)return a.screens[c];
return null},AWa=function(a,b,c){e8(a.i,b,c)},xWa=function(a,b,c,d){a.info("requestLoungeToken_ for "+b);
...
g.hu(R7(a.C,"/pairing/get_lounge_token_batch"),e)},BWa=function(a){a.screens=a.u.Ih();
var b=a.D,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+Y6(a.screens))},wWa=function(a){j8(a);
a.u=new a8(a.C);a.u.subscribe("screenChange",(0,g.D)(a.ES,a));BWa(a);a.K||(a.B=kVa(g.ry("yt-remote-automatic-screen-cache")||[]));j8(a);a.info("Initializing automatic screens: "+Y6(a.B));a.i=new d8(a.C,(0,g.D)(a.Ih,a,!0));a.i.subscribe("screenChange",(0,g.D)(function(){this.ea("onlineScreenChange")},a))},i8=function(a,b){var c=a.get(b.id);
c?(c.uuid=b.uuid,b=c):((c=a7(a.B,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.B.push(b),a.K||CWa(a));j8(a);a.D[b.uuid]=b.id;g.qy("yt-remote-device-id-map",a.D,31536E3);return b},CWa=function(a){a=g.Cp(a.B,function(b){return"shortLived"!=b.idType});
g.qy("yt-remote-automatic-screen-cache",g.pn(a,iVa))},j8=function(a){a.D=g.ry("yt-remote-device-id-map")||{}},k8=function(a,b,c){g.Q.call(this);
this.Ba=c;this.B=a;this.i=b;this.C=null},l8=function(a,b){a.C=b;
a.ea("sessionScreen",a.C)},DWa=function(a,b){a.C&&(a.C.token=b,i8(a.B,a.C));
a.ea("sessionScreen",a.C)},m8=function(a,b){U7(a.Ba,b)},n8=function(a,b,c){k8.call(this,a,b,"CastSession");
var d=this;this.config_=c;this.u=null;this.oa=(0,g.D)(this.NQ,this);this.Aa=(0,g.D)(this.OW,this);this.Z=g.Mt(function(){EWa(d,null)},12E4);
this.K=this.D=this.I=this.S=0;this.xa=!1;this.X="unknown"},o8=function(a,b){g.Ot(a.K);
a.K=0;0==b?FWa(a):a.K=g.Mt(function(){FWa(a)},b)},FWa=function(a){GWa(a,"getLoungeToken");
g.Ot(a.D);a.D=g.Mt(function(){HWa(a,null)},3E4)},GWa=function(a,b){a.info("sendYoutubeMessage_: "+b+" "+g.zi(void 0));
var c={};c.type=b;a.u?a.u.sendMessage("urn:x-cast:com.google.youtube.mdx",c,g.Ka,(0,g.D)(function(){m8(this,"Failed to send message: "+b+".")},a)):m8(a,"Sending yt message without session: "+g.zi(c))},p8=function(a,b){b?(a.info("onConnectedScreenId_: Received screenId: "+b),a.getScreen()&&a.getScreen().id==b||a.HK(b,function(c){l8(a,c)},function(){return a.zg()},5)):a.zg(Error("Waiting for session status timed out."))},JWa=function(a,b,c){a.info("onConnectedScreenData_: Received screenData: "+JSON.stringify(b));
var d=new V6(b);IWa(a,d,function(e){e?(a.xa=!0,i8(a.B,d),l8(a,d),a.X="unknown",o8(a,c)):(g.vt(Error("CastSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online.")),a.zg())},5)},EWa=function(a,b){g.Ot(a.Z);
a.Z=0;b?a.config_.enableCastLoungeToken&&b.loungeToken?b.deviceId?a.getScreen()&&a.getScreen().uuid==b.deviceId||(b.loungeTokenRefreshIntervalMs?JWa(a,{name:a.i.friendlyName,screenId:b.screenId,loungeToken:b.loungeToken,dialId:b.deviceId,screenIdType:"shortLived"},b.loungeTokenRefreshIntervalMs):(g.vt(Error("No loungeTokenRefreshIntervalMs presents in mdxSessionStatusData: "+JSON.stringify(b)+".")),p8(a,b.screenId))):(g.vt(Error("No device id presents in mdxSessionStatusData: "+JSON.stringify(b)+
".")),p8(a,b.screenId)):p8(a,b.screenId):a.zg(Error("Waiting for session status timed out."))},HWa=function(a,b){g.Ot(a.D);
a.D=0;var c=null;if(b)if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";else c="noLoungeTokenResponse";c?(a.info("Did not receive a new lounge token in onLoungeToken_ with data: "+(JSON.stringify(b)+", error: "+c)),a.X=c,o8(a,3E4)):(DWa(a,b.loungeToken),a.xa=!1,a.X="unknown",o8(a,b.loungeTokenRefreshIntervalMs))},IWa=function(a,b,c,d){g.Ot(a.I);
a.I=0;AWa(a.B,b,function(e){e||0>d?c(e):a.I=g.Mt(function(){IWa(a,b,c,d-1)},300)})},KWa=function(a){g.Ot(a.S);
...
return!!(a.config_.enableDialLoungeToken&&(null==(b=a.u)?0:b.getDialAppInfo))},LWa=function(a){a.D=a.B.qI(a.Aa,a.i.label,a.i.friendlyName,r8(a),function(b,c){a.D=g.Ka;
a.oa=!0;l8(a,b);"shortLived"==b.idType&&0<c&&s8(a,c)},function(b){a.D=g.Ka;
a.zg(b)})},MWa=function(a){var b={};
b.pairingCode=a.Aa;b.theme=a.La;vVa()&&(b.env_useStageMdx=1);return g.Si(b)},t8=function(a){return new Promise(function(b){a.Aa=Z6();
if(a.Ka){var c=new chrome.cast.DialLaunchResponse(!0,MWa(a));b(c);LWa(a)}else a.Z=function(){g.Ot(a.X);a.Z=function(){};
a.X=NaN;var d=new chrome.cast.DialLaunchResponse(!0,MWa(a));b(d);LWa(a)},a.X=g.Mt(function(){a.Z()},100)})},OWa=function(a,b,c){a.info("initOnConnectedScreenDataPromise_: Received screenData: "+JSON.stringify(b));
var d=new V6(b);return(new Promise(function(e){NWa(a,d,function(f){f?(a.oa=!0,i8(a.B,d),l8(a,d),s8(a,c)):g.vt(Error("DialSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online."));e(f)},5)})).then(function(e){return e?new chrome.cast.DialLaunchResponse(!1):t8(a)})},PWa=function(a,b){var c=a.S.receiver.label,d=a.i.friendlyName;
return(new Promise(function(e){yWa(a.B,c,b,d,function(f){f&&f.token&&l8(a,f);e(f)},function(f){m8(a,"Failed to get DIAL screen: "+f);
e(null)})})).then(function(e){return e&&e.token?new chrome.cast.DialLaunchResponse(!1):t8(a)})},NWa=function(a,b,c,d){g.Ot(a.I);
a.I=0;AWa(a.B,b,function(e){e||0>d?c(e):a.I=g.Mt(function(){NWa(a,b,c,d-1)},300)})},s8=function(a,b){a.info("getDialAppInfoWithTimeout_ "+b);
r8(a)&&(g.Ot(a.K),a.K=0,0==b?QWa(a):a.K=g.Mt(function(){QWa(a)},b))},QWa=function(a){r8(a)&&a.u.getDialAppInfo(function(b){a.info("getDialAppInfo dialLaunchData: "+JSON.stringify(b));
b=b.extraData||{};var c=null;if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";c?(a.xa=c,s8(a,3E4)):(a.oa=!1,a.xa="unknown",DWa(a,b.loungeToken),s8(a,b.loungeTokenRefreshIntervalMs))},function(b){a.info("getDialAppInfo error: "+b);
a.xa="noLoungeTokenResponse";s8(a,3E4)})},RWa=function(a){g.Ot(a.I);
...
this.config_=b;this.u=a;this.S=b.appId||"233637DE";this.C=b.theme||"cl";this.X=b.disableCastApi||!1;this.I=b.forceMirroring||!1;this.i=null;this.K=!1;this.B=[];this.D=(0,g.D)(this.FV,this)},SWa=function(a,b){return b?g.Tb(a.B,function(c){return W6(b,c.label)},a):null},w8=function(a){U7("Controller",a)},jWa=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},x8=function(a){return a.K||!!a.B.length||!!a.i},y8=function(a,b,c){b!=a.i&&(g.re(a.i),(a.i=b)?(c?a.ea("yt-remote-cast2-receiver-resumed",
b.i):a.ea("yt-remote-cast2-receiver-selected",b.i),b.subscribe("sessionScreen",(0,g.D)(a.YM,a,b)),b.subscribe("sessionFailed",function(){return TWa(a,b)}),b.getScreen()?a.ea("yt-remote-cast2-session-change",b.getScreen()):c&&a.i.Ts(null)):a.ea("yt-remote-cast2-session-change",null))},TWa=function(a,b){a.i==b&&a.ea("yt-remote-cast2-session-failed")},UWa=function(a){var b=a.u.pI(),c=a.i&&a.i.i;
a=g.pn(b,function(d){c&&W6(d,c.label)&&(c=null);var e=d.uuid?d.uuid:d.id,f=SWa(this,d);f?(f.label=e,f.friendlyName=d.name):(f=new chrome.cast.Receiver(e,d.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},ZWa=function(a,b,c,d){d.disableCastApi?z8("Cannot initialize because disabled by Mdx config."):VWa()?WWa(b,d)&&(A8(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?XWa(a,c):(window.__onGCastApiAvailable=function(e,f){e?XWa(a,c):(B8("Failed to load cast API: "+f),C8(!1),A8(!1),g.sy("yt-remote-cast-available"),g.sy("yt-remote-cast-receiver"),
YWa(),c(!1))},d.loadCastApiSetupScript?g.uy("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):0<=window.navigator.userAgent.indexOf("Android")&&0<=window.navigator.userAgent.indexOf("Chrome/")&&window.navigator.presentation?60<=h7()&&CVa():!window.chrome||!window.navigator.presentation||0<=window.navigator.userAgent.indexOf("Edge")?j7():89<=h7()?EVa():(k7(),i7(DVa.map(zVa))))):z8("Cannot initialize because not running Chrome")},YWa=function(){z8("dispose");
var a=D8();a&&a.dispose();g.Ia("yt.mdx.remote.cloudview.instance_",null,void 0);$Wa(!1);g.tv(E8);E8.length=0},F8=function(){return!!g.ry("yt-remote-cast-installed")},aXa=function(){var a=g.ry("yt-remote-cast-receiver");
return a?a.friendlyName:null},bXa=function(){z8("clearCurrentReceiver");
g.sy("yt-remote-cast-receiver")},cXa=function(){return F8()?D8()?D8().getCastSession():(B8("getCastSelector: Cast is not initialized."),null):(B8("getCastSelector: Cast API is not installed!"),null)},H8=function(){F8()?D8()?G8()?(z8("Requesting cast selector."),D8().requestSession()):(z8("Wait for cast API to be ready to request the session."),E8.push(g.rv("yt-remote-cast2-api-ready",H8))):B8("requestCastSelector: Cast is not initialized."):B8("requestCastSelector: Cast API is not installed!")},I8=
function(a,b){G8()?D8().setConnectedScreenStatus(a,b):B8("setConnectedScreenStatus called before ready.")},VWa=function(){var a=0<=g.yb().search(/ (CrMo|Chrome|CriOS)\//);
return g.Ej||a},dXa=function(a,b){D8().init(a,b)},WWa=function(a,b){var c=!1;
...
z8("cloudview.createSingleton_: "+c);return c},D8=function(){return g.Ja("yt.mdx.remote.cloudview.instance_")},XWa=function(a,b){C8(!0);
A8(!1);dXa(a,function(c){c?($Wa(!0),g.uv("yt-remote-cast2-api-ready")):(B8("Failed to initialize cast API."),C8(!1),g.sy("yt-remote-cast-available"),g.sy("yt-remote-cast-receiver"),YWa());b(c)})},z8=function(a){U7("cloudview",a)},B8=function(a){U7("cloudview",a)},C8=function(a){z8("setCastInstalled_ "+a);
g.qy("yt-remote-cast-installed",a)},G8=function(){return!!g.Ja("yt.mdx.remote.cloudview.apiReady_")},$Wa=function(a){z8("setApiReady_ "+a);
...
this.B=0;this.C=a;this.I=[];this.D=new fWa;this.u=this.i=null;this.X=(0,g.D)(this.nU,this);this.K=(0,g.D)(this.Gw,this);this.S=(0,g.D)(this.mU,this);this.Z=(0,g.D)(this.uU,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.vG,this),eXa(this))):c=3;0!=c&&(b?this.vG(c):g.Mt((0,g.D)(function(){this.vG(c)},this),0));
(a=cXa())&&Q8(this,a);this.subscribe("yt-remote-cast2-session-change",this.Z)},S8=function(a){return new J8(a.C.getPlayerContextData())},eXa=function(a){g.sc("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange multiStateLoopEnabled loopModeChange".split(" "),function(b){this.I.push(this.C.subscribe(b,g.Ra(this.CV,b),this))},a)},fXa=function(a){g.sc(a.I,function(b){this.C.unsubscribeByKey(b)},a);
...
M8(d,c);-1E3!=d.playerState&&(d.playerState=b);V8(a,d)},X8=function(a,b,c){a.C.sendMessage(b,c)},V8=function(a,b){fXa(a);
a.C.setPlayerContextData(P8(b));eXa(a)},Q8=function(a,b){a.u&&(a.u.removeUpdateListener(a.X),a.u.removeMediaListener(a.K),a.Gw(null));
a.u=b;a.u&&(U7("CP","Setting cast session: "+a.u.sessionId),a.u.addUpdateListener(a.X),a.u.addMediaListener(a.K),a.u.media.length&&a.Gw(a.u.media[0]))},gXa=function(a){var b=a.i.media,c=a.i.customData;
...
g.Q.call(this);this.D=NaN;this.xa=!1;this.S=this.K=this.Z=this.oa=NaN;this.X=[];this.C=this.I=this.B=this.lc=this.i=null;this.Ja=a;this.Ba=d;this.X.push(g.Vu(window,"beforeunload",(0,g.D)(this.qS,this)));this.u=[];this.lc=new J8;this.Ka=b.id;this.Aa=b.idType;this.i=hXa(this,c);this.i.subscribe("handlerOpened",this.rU,this);this.i.subscribe("handlerClosed",this.oU,this);this.i.subscribe("handlerError",this.pU,this);this.i.subscribe("handlerMessage",this.qU,this);this.i.dB(b.token);this.subscribe("remoteQueueChange",
function(){var e=this.lc.videoId;g.ty()&&g.qy("yt-remote-session-video-id",e)},this)},iXa=function(a){return g.Tb(a.u,function(b){return"LOUNGE_SCREEN"==b.type})},$8=function(a){U7("conn",a)},hXa=function(a,b){return new N7(R7(a.Ja,"/bc"),b,!1,function(){return a.uI()},"shortLived"==a.Aa)},a9=function(a,b){a.ea("proxyStateChange",b)},jXa=function(a){a.D=g.Mt((0,g.D)(function(){$8("Connecting timeout");
this.qs(1)},a),2E4)},b9=function(a){g.Ot(a.D);
a.D=NaN},c9=function(a){g.Ot(a.oa);
a.oa=NaN},kXa=function(a){d9(a);
a.Z=g.Mt((0,g.D)(function(){e9(this,"getNowPlaying")},a),2E4)},d9=function(a){g.Ot(a.Z);
a.Z=NaN},mXa=function(a,b){var c=null;
if(b){var d=iXa(a);d&&(c={clientName:d.clientName,deviceMake:d.brand,deviceModel:d.model,osVersion:d.osVersion})}g.Ia("yt.mdx.remote.remoteClient_",c,void 0);b&&(b9(a),c9(a));c=P7(a.i)&&isNaN(a.D);b==c?b&&(a9(a,1),e9(a,"getSubtitlesTrack")):b?(a.GK()&&a.lc.reset(),a9(a,1),e9(a,"getNowPlaying"),lXa(a)):a.qs(1)},nXa=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.lc.videoId&&(g.Se(b.params)?a.lc.trackData=null:a.lc.trackData=b.params,a.ea("remotePlayerChange"))},oXa=function(a,b,c){var d=b.params.videoId||b.params.video_id,e=parseInt(b.params.currentIndex,10);
a.lc.listId=b.params.listId||a.lc.listId;O8(a.lc,d,e);a.ea("remoteQueueChange",c)},qXa=function(a,b){b.params=b.params||{};
oXa(a,b,"NOW_PLAYING_MAY_CHANGE");pXa(a,b);a.ea("autoplayDismissed")},pXa=function(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10);
M8(a.lc,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.lc.playerState&&(c=-1E3);a.lc.playerState=c;c=Number(b.params.loadedTime);a.lc.S=isNaN(c)?0:c;a.lc.Nj(Number(b.params.duration));c=a.lc;var d=Number(b.params.liveIngestionTime);c.B=d;c.u=isNaN(d)?!1:!0;c=a.lc;d=Number(b.params.seekableStartTime);b=Number(b.params.seekableEndTime);c.C=isNaN(d)?0:d;c.i=isNaN(b)?0:b;1==a.lc.playerState?kXa(a):d9(a);a.ea("remotePlayerChange")},rXa=function(a,b){if(-1E3!=a.lc.playerState){var c=
1085;
switch(parseInt(b.params.adState,10)){case 1:c=1081;break;case 2:c=1084;break;case 0:c=1083}a.lc.playerState=c;b=parseInt(b.params.currentTime,10);M8(a.lc,isNaN(b)?0:b);a.ea("remotePlayerChange")}},sXa=function(a,b){var c="true"==b.params.muted;
a.lc.volume=parseInt(b.params.volume,10);a.lc.muted=c;a.ea("remotePlayerChange")},tXa=function(a,b){a.I=b.params.videoId;
a.ea("nowAutoplaying",parseInt(b.params.timeout,10))},uXa=function(a,b){var c="true"==b.params.hasNext;
a.lc.Lk="true"==b.params.hasPrevious;a.lc.hasNext=c;a.ea("previousNextChange")},lXa=function(a){g.Ot(a.S);
...
this.Se=a;this.i=[];this.i.push(this.Se.$_s("screenChange",(0,g.D)(this.SQ,this)));this.i.push(this.Se.$_s("onlineScreenChange",(0,g.D)(this.jV,this)))},yXa=function(a,b){uVa();
if(!g7||!g7.get("yt-remote-disable-remote-module-for-dev")){b=g.N("MDX_CONFIG")||b;mVa();e7();g9||(g9=new Q7(b?b.loungeApiHost:void 0),vVa()&&(g9.i="/api/loungedev"));h9||(h9=g.Ja("yt.mdx.remote.deferredProxies_")||[],g.Ia("yt.mdx.remote.deferredProxies_",h9,void 0));vXa();var c=i9();if(!c){var d=new h8(g9,b?b.disableAutomaticScreenCache||!1:!1);g.Ia("yt.mdx.remote.screenService_",d,void 0);c=i9();var e={};b&&(e={appId:b.appId,disableDial:b.disableDial,theme:b.theme,loadCastApiSetupScript:b.loadCastApiSetupScript,
disableCastApi:b.disableCastApi,enableDialLoungeToken:b.enableDialLoungeToken,enableCastLoungeToken:b.enableCastLoungeToken,forceMirroring:b.forceMirroring});g.Ia("yt.mdx.remote.enableConnectWithInitialState_",b?b.enableConnectWithInitialState||!1:!1,void 0);ZWa(a,d,function(f){f?j9()&&I8(j9(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){T6("yt-remote-receiver-availability-change")})},e)}b&&!g.Ja("yt.mdx.remote.initialized_")&&(g.Ia("yt.mdx.remote.initialized_",!0,void 0),k9("Initializing: "+
...
T6("yt-remote-auto-connect","cast-selector-receiver")})),l9.push(g.rv("yt-remote-cast2-receiver-resumed",function(){T6("yt-remote-receiver-resumed","cast-selector-receiver")})),l9.push(g.rv("yt-remote-cast2-session-change",wXa)),l9.push(g.rv("yt-remote-connection-change",function(f){f?I8(j9(),"YouTube TV"):n9()||(I8(null,null),bXa())})),l9.push(g.rv("yt-remote-cast2-session-failed",function(){T6("yt-remote-connection-failed")})),a=o9(),b.isAuto&&(a.id+="#dial"),e=b.capabilities||[],g.O("desktop_enable_autoplay")&&
e.push("atp"),0<e.length&&(a.capabilities=e),a.name=b.device,a.app=b.app,(b=b.theme)&&(a.theme=b),k9(" -- with channel params: "+g.zi(a)),a?(g.qy("yt-remote-session-app",a.app),g.qy("yt-remote-session-name",a.name)):(g.sy("yt-remote-session-app"),g.sy("yt-remote-session-name")),g.Ia("yt.mdx.remote.channelParams_",a,void 0),c.start(),j9()||xXa())}},zXa=function(){var a=i9().Se.$_gos();
var b=p9();b&&q9()&&($6(a,b)||a.push(b));return lVa(a)},r9=function(){var a=AXa();
!a&&F8()&&aXa()&&(a={key:"cast-selector-receiver",name:aXa()});return a},AXa=function(){var a=zXa(),b=p9();
b||(b=n9());return g.Tb(a,function(c){return b&&W6(b,c.key)?!0:!1})},p9=function(){var a=j9();
if(!a)return null;var b=i9().Ih();return a7(b,a)},wXa=function(a){k9("remote.onCastSessionChange_: "+X6(a));
...
m9(null);a||BXa("");g.Ia("yt.mdx.remote.connection_",a,void 0);h9&&(g.sc(h9,function(c){c(a)}),h9.length=0);
...
p9()&&p9();if(y9)s9=a;else{BXa(a.id);var c=g.Ja("yt.mdx.remote.enableConnectWithInitialState_")||!1;a=new Z8(g9,a,o9(),c);a.connect(b,CXa());a.subscribe("beforeDisconnect",function(d){T6("yt-remote-before-disconnect",d)});
...
v9(a)}},xXa=function(){var a=n9();
a?(k9("Resume connection to: "+X6(a)),u9(a,0)):(f7(),bXa(),k9("Skipping connecting because no session screen found."))},vXa=function(){var a=o9();
...
var d=this;this.u=a;this.J=b;this.Tb=c;this.events=new g.JC(this);this.Z=this.events.T(this.J,"onVolumeChange",function(e){DXa(d,e)});
...
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.J.getVideoData(1);a.Tb.playVideo(c.videoId,b,d,e,c.playerParams,c.Za,bVa(c));a.Ub(new g.tJ(1))},FXa=function(a,b){if(b){var c=a.J.getOption("captions","tracklist",{eL:1});
...
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-popup-title",va:"\u0412\u044b \u0432\u044b\u0448\u043b\u0438 \u0438\u0437 \u0430\u043a\u043a\u0430\u0443\u043d\u0442\u0430"},{G:"div",L:"ytp-mdx-popup-description",va:'\u0420\u043e\u043b\u0438\u043a\u0438, \u043a\u043e\u0442\u043e\u0440\u044b\u0435 \u0432\u044b \u043f\u043e\u0441\u043c\u043e\u0442\u0440\u0438\u0442\u0435, \u043c\u043e\u0433\u0443\u0442 \u0431\u044b\u0442\u044c \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u044b \u0432 \u0438\u0441\u0442\u043e\u0440\u0438\u044e \u043f\u0440\u043e\u0441\u043c\u043e\u0442\u0440\u0430 \u043d\u0430 \u0442\u0435\u043b\u0435\u0432\u0438\u0437\u043e\u0440\u0435, \u0447\u0442\u043e \u0441\u043a\u0430\u0436\u0435\u0442\u0441\u044f \u043d\u0430 \u0440\u0435\u043a\u043e\u043c\u0435\u043d\u0434\u0430\u0446\u0438\u044f\u0445. \u0427\u0442\u043e\u0431\u044b \u044d\u0442\u043e\u0433\u043e \u0438\u0437\u0431\u0435\u0436\u0430\u0442\u044c, \u0432\u044b\u0431\u0435\u0440\u0438\u0442\u0435 "\u041e\u0442\u043c\u0435\u043d\u0430" \u0438 \u0432\u043e\u0439\u0434\u0438\u0442\u0435 \u0432 \u0430\u043a\u043a\u0430\u0443\u043d\u0442 \u043d\u0430 \u043a\u043e\u043c\u043f\u044c\u044e\u0442\u0435\u0440\u0435.'},
{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-cancel"],va:"\u041e\u0442\u043c\u0435\u043d\u0430"},{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-confirm"],va:"\u041e\u041a"}]}]}]});this.i=new g.ZK(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.H(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},E9=function(a){g.W.call(this,
{G:"div",
L:"ytp-remote",U:[{G:"div",L:"ytp-remote-display-status",U:[{G:"div",L:"ytp-remote-display-status-icon",U:[g.Iva()]},{G:"div",L:"ytp-remote-display-status-text",va:"{{statustext}}"}]}]});this.api=a;this.i=new g.ZK(this,250);g.H(this,this.i);this.T(a,"presentingplayerstatechange",this.onStateChange);GXa(this,a.zb())},GXa=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
b=g.T(b,128)?g.AH('\u041e\u0448\u0438\u0431\u043a\u0430 \u043d\u0430 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0435 "$RECEIVER_NAME"',c):b.Ec()||g.T(b,4)?g.AH('\u0412\u043e\u0441\u043f\u0440\u043e\u0438\u0437\u0432\u0435\u0434\u0435\u043d\u0438\u0435 \u043d\u0430 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0435 "$RECEIVER_NAME"',c):g.AH('\u0423\u0441\u0442\u0430\u043d\u043e\u0432\u043b\u0435\u043d\u043e \u043f\u043e\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u0435 \u043a \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0443 "$RECEIVER_NAME"',
c);a.Pa("statustext",b);a.i.show()}else a.i.hide()},F9=function(a,b){g.wP.call(this,"\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u043e \u0434\u043b\u044f \u043f\u0440\u043e\u0441\u043c\u043e\u0442\u0440\u0430",0,a,b);
...
this.Tk={key:Z6(),name:"\u042d\u0442\u043e\u0442 \u043a\u043e\u043c\u043f\u044c\u044e\u0442\u0435\u0440"};this.di=null;this.subscriptions=[];this.UF=this.Tb=null;this.Ho=[this.Tk];this.un=this.Tk;this.Bd=new g.tJ(64);this.DL=0;this.wf=-1;this.Tw=!1;this.Rw=this.wt=null;if(!g.sE(this.player.V())&&!g.tE(this.player.V())){a=this.player;var b=g.iM(a);b&&(b=b.Ln())&&(b=new F9(a,b),g.H(this,b));b=new E9(a);g.H(this,b);g.sM(a,b.element,4);this.wt=new D9;g.H(this,this.wt);g.sM(a,this.wt.element,4);this.Tw=
!!n9()}},H9=function(a){a.Rw&&(a.player.removeEventListener("presentingplayerstatechange",a.Rw),a.Rw=null)},HXa=function(a,b,c){a.Bd=c;
a.player.ea("presentingplayerstatechange",new g.jH(c,b))},I9=function(a,b){if(b.key!==a.un.key)if(b.key===a.Tk.key)t9();
else{var c;(c=!a.player.V().N("mdx_enable_privacy_disclosure_ui"))||(c=((c=g.N("PLAYER_CONFIG"))&&c.args&&void 0!==c.args.authuser?!0:!(!g.N("SESSION_INDEX")&&!g.N("LOGGED_IN")))||a.Tw||!a.wt);(c?0:g.JE(a.player.V())||g.ME(a.player.V()))&&IXa(a);a.un=b;if(!a.player.V().N("disable_mdx_connection_in_mdx_module_for_music_web")||!g.tE(a.player.V())){var d=a.player.getPlaylistId();c=a.player.getVideoData(1);var e=c.videoId;if(!d&&!e||(2===a.player.getAppState()||1===a.player.getAppState())&&a.player.V().N("should_clear_video_data_on_player_cued_unstarted"))a=
null;else{var f=a.player.getPlaylist();if(f){var h=[];for(var l=0;l<f.length;l++)h[l]=g.zM(f,l).videoId}else h=[e];f=a.player.getCurrentTime(1);a={videoIds:h,listId:d,videoId:e,playerParams:c.playerParams,clickTrackingParams:c.Za,index:Math.max(a.player.getPlaylistIndex(),0),currentTime:0===f?void 0:f};(c=bVa(c))&&(a.locationInfo=c)}k9("Connecting to: "+g.zi(b));"cast-selector-receiver"==b.key?(m9(a||null),b=a||null,G8()?D8().setLaunchParams(b):B8("setLaunchParams called before ready.")):!a&&w9()&&
j9()==b.key?T6("yt-remote-connection-change",!0):(t9(),m9(a||null),a=i9().Ih(),(b=a7(a,b.key))&&u9(b,1))}}},IXa=function(a){a.player.zb().Ec()?a.player.pauseVideo():(a.Rw=function(b){!a.Tw&&g.lH(b,8)&&(a.player.pauseVideo(),H9(a))},a.player.addEventListener("presentingplayerstatechange",a.Rw));
a.wt&&a.wt.Ad();q9()||(y9=!0)},KVa={"\x00":"\\0",
"\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\x0B",'"':'\\"',"\\":"\\\\","<":"\\u003C"},y7={"'":"\\'"},hVa={AZ:"atp",baa:"ska",L9:"que",C7:"mus",aaa:"sus",D3:"dsp",i$:"seq",f7:"mic",u2:"dpa",PZ:"cds",A7:"mlm",q2:"dsdtr"};U6.prototype.equals=function(a){return a?this.id==a.id:!1};
var g7,c7="",BVa=wVa("loadCastFramework")||wVa("loadCastApplicationFramework"),DVa=["pkedcjkdefgpdelpbcmbmeomcjbeemfm","enhhojjnijigcajfphajepfemndkmdlo"];/*
...
o7.prototype.parse=function(a){return g.B.JSON.parse(a,void 0)};var q7=new g.rf;g.w(FVa,g.ue);g.k=s7.prototype;g.k.Zo=null;g.k.Km=!1;g.k.du=null;g.k.nH=null;g.k.Ct=null;g.k.Pt=null;g.k.cn=null;g.k.Ko=null;g.k.Aq=null;g.k.Mf=null;g.k.DB=0;g.k.Rj=null;g.k.BB=null;g.k.Tm=null;g.k.Hu=-1;g.k.RN=!0;g.k.vp=!1;g.k.pC=0;g.k.RA=null;var IVa={},v7={};g.k=s7.prototype;g.k.setTimeout=function(a){this.u=a};
g.k.IQ=function(a){a=a.target;var b=this.RA;b&&3==g.gj(a)?b.oI():this.VO(a)};
g.k.VO=function(a){try{if(a==this.Mf)a:{var b=g.gj(this.Mf),c=this.Mf.u,d=this.Mf.getStatus();if(g.Jc&&!g.Bc(10)||g.Yg&&!g.zc("420+")){if(4>b)break a}else if(3>b||3==b&&!g.lj(this.Mf))break a;this.vp||4!=b||7==c||(8==c||0>=d?this.i.Ej(3):this.i.Ej(2));z7(this);var e=this.Mf.getStatus();this.Hu=e;var f=g.lj(this.Mf);if(this.Km=200==e){4==b&&w7(this);if(this.D){for(a=!0;!this.vp&&this.DB<f.length;){var h=JVa(this,f);if(h==v7){4==b&&(this.Tm=4,r7(15),a=!1);break}else if(h==IVa){this.Tm=4;r7(16);a=!1;
...
g.k.KW=function(){this.du=null;var a=Date.now();0<=a-this.nH?(2!=this.Pt&&this.i.Ej(3),w7(this),this.Tm=2,r7(18),x7(this)):MVa(this,this.nH-a)};
g.k.getLastError=function(){return this.Tm};g.k=PVa.prototype;g.k.qC=null;g.k.uh=null;g.k.SA=!1;g.k.eO=null;g.k.Wy=null;g.k.QE=null;g.k.rC=null;g.k.Yh=null;g.k.xl=-1;g.k.Iu=null;g.k.Uu=null;g.k.connect=function(a){this.rC=a;a=C7(this.i,null,this.rC);r7(3);this.eO=Date.now();var b=this.i.S;null!=b?(this.Iu=b[0],(this.Uu=b[1])?(this.Yh=1,QVa(this)):(this.Yh=2,E7(this))):(Q6(a,"MODE","init"),this.uh=new s7(this,void 0,void 0,void 0),this.uh.Zo=this.qC,t7(this.uh,a,!1,null,!0),this.Yh=0)};
...
a&&I7(this),!g.kb(b))for(a=this.D.parse(b),b=0;b<a.length;b++)c=a[b],this.Ss=c[0],c=c[1],2==this.i?"c"==c[0]?(this.B=c[1],this.jy=c[2],c=c[3],null!=c?this.wp=c:this.wp=6,this.i=3,this.Nf&&this.Nf.JJ(),this.rJ=C7(this,this.vx()?this.jy:null,this.sC),bWa(this)):"stop"==c[0]&&L7(this,7):3==this.i&&("stop"==c[0]?L7(this,7):"noop"!=c[0]&&this.Nf&&this.Nf.IJ(c),this.Sr=0)};
g.k.hU=function(){null!=this.Ep&&(this.Ep=null,this.Je.cancel(),this.Je=null,K7(this),r7(20))};
g.k.iy=function(a){if(this.Je==a){I7(this);this.Je=null;var b=2}else if(this.Ug==a)this.Ug=null,b=1;else return;this.ek=a.Hu;if(0!=this.i)if(a.Km)if(1==b){b=Date.now()-a.Ct;var c=q7;c.dispatchEvent(new SVa(c,a.Aq?a.Aq.length:0,b,this.xs));H7(this);this.C.length=0}else bWa(this);else{c=a.getLastError();var d;if(!(d=3==c||7==c||0==c&&0<this.ek)){if(d=1==b)this.Ug||this.Dn||1==this.i||2<=this.xs?d=!1:(this.Dn=p7((0,g.D)(this.aN,this,a),cWa(this,this.xs)),this.xs++,d=!0);d=!(d||2==b&&K7(this))}if(d)switch(c){case 1:L7(this,
...
g.k.LX=function(a){a?r7(2):(r7(1),dWa(this,8))};
...
g.k.Ej=function(a){var b=q7;b.dispatchEvent(new TVa(b,a))};
g.k.vx=function(){return!(!g.Jc||g.Bc(10))};
g.k=eWa.prototype;g.k.JJ=function(){};
g.k.IJ=function(){};
g.k.HJ=function(){};
g.k.jD=function(){};
g.k.uK=function(){return{}};
g.k.isActive=function(){return!0};g.k=fWa.prototype;g.k.isEmpty=function(){return 0===this.i.length&&0===this.u.length};
...
g.k.isActive=function(){return this.i.isActive()};
g.k.reset=function(){this.i.stop();this.Wf=5E3};g.Ua(N7,eWa);g.k=N7.prototype;g.k.subscribe=function(a,b,c){return this.B.subscribe(a,b,c)};
...
g.k.dispose=function(){this.Z||(this.Z=!0,g.re(this.B),iWa(this),g.re(this.u),this.u=null,this.oa=function(){return""})};
g.k.isDisposed=function(){return this.Z};
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.X="";this.u.stop();this.D=a||null;this.C=b||0;a=this.xa+"/test";b=this.xa+"/bind";var d=new F7(c?c.firstTestResults:null,c?c.secondTestResults:null,this.Aa),e=this.i;e&&(e.Nf=null);d.Nf=this;this.i=d;O7(this);if(this.i){d=g.N("ID_TOKEN");var f=this.i.dk||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.dk=f}e?(3!=e.getState()&&0==ZVa(e)||e.getState(),this.i.connect(a,b,this.I,e.B,e.Ss)):c?this.i.connect(a,
b,this.I,c.sessionId,c.arrayId):this.i.connect(a,b,this.I)}};
g.k.sendMessage=function(a,b){a={_sc:a};b&&g.Ze(a,b);this.u.isActive()||2==(this.i?this.i.getState():0)?this.K.push(a):P7(this)&&(O7(this),YVa(this.i,a))};
g.k.JJ=function(){this.u.reset();this.D=null;this.C=0;if(this.K.length){var a=this.K;this.K=[];for(var b=0,c=a.length;b<c;++b)YVa(this.i,a[b])}this.ea("handlerOpened")};
...
g.k.IJ=function(a){"S"==a[0]?this.X=a[1]:"gracefulReconnect"==a[0]?(this.u.start(),WVa(this.i)):this.ea("handlerMessage",new gWa(a[0],a[1]))};
...
g.k.pX=function(){this.u.isActive();0==ZVa(this.i)&&this.connect(this.D,this.C)};Q7.prototype.C=function(a,b,c,d){b?a(d):a({text:c.responseText})};
Q7.prototype.B=function(a,b){a(Error("Request error: "+b.status))};
Q7.prototype.D=function(a){a(Error("request timed out"))};var pWa=Date.now(),T7=null,W7=Array(50),V7=-1,X7=!1;g.Ua(Y7,g.Q);Y7.prototype.Ih=function(){return this.screens};
...
g.k.JQ=function(a){this.i=null;a.status&&404==a.status?this.u>=JXa.length?this.ea("pairingFailed",Error("DIAL polling timed out")):(a=JXa[this.u],this.Mb=g.Mt((0,g.D)(this.mN,this),a),this.u++):this.ea("pairingFailed",Error("Server error "+a.status))};
g.k.LQ=function(){this.i=null;this.ea("pairingFailed",Error("Server not responding"))};
var JXa=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Ua(a8,Y7);g.k=a8.prototype;g.k.start=function(){$7(this)&&this.ea("screenChange");!g.ry("yt-remote-lounge-token-expiration")&&tWa(this);g.Ot(this.i);this.i=g.Mt((0,g.D)(this.start,this),1E4)};
g.k.add=function(a,b){$7(this);qWa(this,a);b8(this,!1);this.ea("screenChange");b(a);a.token||tWa(this)};
g.k.remove=function(a,b){var c=$7(this);sWa(this,a)&&(b8(this,!1),c=!0);b(a);c&&this.ea("screenChange")};
...
g.k.gG=function(){g.Ot(this.B);this.B=NaN;this.u&&this.u.abort();var a=vWa(this);if(R6(a)){var b=R7(this.D,"/pairing/get_screen_availability");this.u=S7(this.D,b,{lounge_token:g.Ne(a).join(",")},(0,g.D)(this.YV,this,a),(0,g.D)(this.XV,this))}else f8(this,{}),g8(this)};
g.k.YV=function(a,b){this.u=null;var c=g.Ne(vWa(this));if(g.qc(c,g.Ne(a))){b=b.screens||[];c={};for(var d=0,e=b.length;d<e;++d)c[a[b[d].loungeToken]]="online"==b[d].status;f8(this,c);g8(this)}else this.ke("Changing Screen set during request."),this.gG()};
...
g.k.MQ=function(a,b,c,d){g.hu(R7(this.C,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.D)(function(e,f){e=new V6(f.screen||{});if(!e.name||zWa(this,e.name)){a:{f=e.name;for(var h=2,l=b(f,h);zWa(this,l);){h++;if(20<h)break a;l=b(f,h)}f=l}e.name=f}c(i8(this,e))},this),
...
g.k.ES=function(){BWa(this);this.ea("screenChange");this.i.update()};
...
g.k.ya=function(){this.uG("");k8.je.ya.call(this)};g.w(n8,k8);g.k=n8.prototype;g.k.tG=function(a){if(this.u){if(this.u==a)return;m8(this,"Overriding cast session with new session object");KWa(this);this.xa=!1;this.X="unknown";this.u.removeUpdateListener(this.oa);this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa)}this.u=a;this.u.addUpdateListener(this.oa);this.u.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa);GWa(this,"getMdxSessionStatus")};
...
g.k.uG=function(){};
g.k.ya=function(){this.info("disposeInternal");KWa(this);this.u&&(this.u.removeUpdateListener(this.oa),this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa));this.u=null;k8.prototype.ya.call(this)};
g.k.OW=function(a,b){if(!this.isDisposed())if(b)if(b=S6(b),g.Oa(b))switch(a=""+b.type,b=b.data||{},this.info("onYoutubeMessage_: "+a+" "+g.zi(b)),a){case "mdxSessionStatus":EWa(this,b);break;case "loungeToken":HWa(this,b);break;default:m8(this,"Unknown youtube message: "+a)}else m8(this,"Unable to parse message.");else m8(this,"No data in message.")};
g.k.HK=function(a,b,c,d){g.Ot(this.S);this.S=0;yWa(this.B,this.i.label,a,this.i.friendlyName,(0,g.D)(function(e){e?b(e):0<=d?(m8(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.S=g.Mt((0,g.D)(this.HK,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.k.stop=function(){RWa(this);this.u?this.u.stop((0,g.D)(this.zg,this,null),(0,g.D)(this.zg,this,"Failed to stop DIAL device.")):this.zg()};
g.k.ya=function(){RWa(this);this.u&&this.u.removeUpdateListener(this.Ja);this.u=null;k8.prototype.ya.call(this)};
...
chrome.cast.initialize(c,(0,g.D)(function(){this.isDisposed()||(chrome.cast.addReceiverActionListener(this.D),mWa(),this.u.subscribe("onlineScreenChange",(0,g.D)(this.sI,this)),this.B=UWa(this),chrome.cast.setCustomReceivers(this.B,g.Ka,(0,g.D)(function(f){this.ke("Failed to set initial custom receivers: "+g.zi(f))},this)),this.ea("yt-remote-cast2-availability-change",x8(this)),b(!0))},this),(0,g.D)(function(f){this.ke("Failed to initialize API: "+g.zi(f));
b(!1)},this))};
g.k.uX=function(a,b){w8("Setting connected screen ID: "+a+" -> "+b);if(this.i){var c=this.i.getScreen();if(!a||c&&c.id!=a)w8("Unsetting old screen status: "+this.i.i.friendlyName),y8(this,null)}if(a&&b){if(!this.i){c=a7(this.u.Ih(),a);if(!c){w8("setConnectedScreenStatus: Unknown screen.");return}if("shortLived"==c.idType){w8("setConnectedScreenStatus: Screen with id type to be short lived.");return}a=SWa(this,c);a||(w8("setConnectedScreenStatus: Connected receiver not custom..."),a=new chrome.cast.Receiver(c.uuid?
...
g.k.ya=function(){this.u.unsubscribe("onlineScreenChange",(0,g.D)(this.sI,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.D);var a=jWa,b=g.Ja("yt.mdx.remote.debug.handlers_");g.$b(b||[],a);g.re(this.i);g.Q.prototype.ya.call(this)};
...
g.k.sI=function(){this.isDisposed()||(this.B=UWa(this),w8("Updating custom receivers: "+g.zi(this.B)),chrome.cast.setCustomReceivers(this.B,g.Ka,(0,g.D)(function(){this.ke("Failed to set custom receivers.")},this)),this.ea("yt-remote-cast2-availability-change",x8(this)))};
...
g.k.ya=function(){fXa(this);this.C=null;this.D.clear();Q8(this,null);g.Q.prototype.ya.call(this)};
...
g.k.Gw=function(a){U7("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.S);if(this.i=a)this.i.addUpdateListener(this.S),gXa(this),this.ea("remotePlayerChange")};
g.k.mU=function(a){a?(gXa(this),this.ea("remotePlayerChange")):this.Gw(null)};
g.k.QG=function(){X8(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.k.uU=function(){var a=cXa();a&&Q8(this,a)};
...
n);this.C="UNSUPPORTED";c=this.Ba?"setInitialState":"setPlaylist";$8("Connecting with "+c+" and params: "+g.zi(m));this.i.connect({method:c,params:g.zi(m)},a,pVa())}else $8("Connecting without params"),this.i.connect({},a,pVa());jXa(this)};
...
mXa(this,a);a=this.nL("mlm");this.ea("multiStateLoopEnabled",a);break;case "loungeScreenDisconnected":g.ac(this.u,function(c){return"LOUNGE_SCREEN"==c.type});
mXa(this,!1);break;case "remoteConnected":var b=new U6(S6(a.params.device));g.Tb(this.u,function(c){return c.equals(b)})||cVa(this.u,b);
break;case "remoteDisconnected":b=new U6(S6(a.params.device));g.ac(this.u,function(c){return c.equals(b)});
break;case "gracefulDisconnect":break;case "playlistModified":oXa(this,a,"QUEUE_MODIFIED");break;case "nowPlaying":qXa(this,a);break;case "onStateChange":pXa(this,a);break;case "onAdStateChange":rXa(this,a);break;case "onVolumeChanged":sXa(this,a);break;case "onSubtitlesTrackChanged":nXa(this,a);break;case "nowAutoplaying":tXa(this,a);break;case "autoplayDismissed":this.ea("autoplayDismissed");break;case "autoplayUpNext":this.I=a.params.videoId||null;this.ea("autoplayUpNext",this.I);break;case "onAutoplayModeChanged":this.C=
a.params.autoplayMode;this.ea("autoplayModeChange",this.C);"DISABLED"==this.C&&this.ea("autoplayDismissed");break;case "onHasPreviousNextChanged":uXa(this,a);break;case "requestAssistedSignIn":this.ea("assistedSignInRequested",a.params.authCode);break;case "onLoopModeChanged":this.ea("loopModeChange",a.params.loopMode);break;default:$8("Unrecognized action: "+a.action)}};
...
g.k.qs=function(a){$8("Disconnecting with "+a);g.Ia("yt.mdx.remote.remoteClient_",null,void 0);b9(this);this.ea("beforeDisconnect",a);1==a&&f7();iWa(this.i,a);this.dispose()};
...
g.k.tX=function(a,b){e9(this,a,b);lXa(this)};
...
g.k.UU=function(){g.Se(this.C)||FXa(this,this.C);this.D=!1};
...
break;case -1:this.Ub(new g.tJ(64));break;case -1E3:this.Ub(new g.tJ(128,{errorCode:"mdx.remoteerror",errorMessage:"\u0412\u0438\u0434\u0435\u043e \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u043e \u0434\u043b\u044f \u0443\u0434\u0430\u043b\u0435\u043d\u043d\u043e\u0433\u043e \u0432\u043e\u0441\u043f\u0440\u043e\u0438\u0437\u0432\u0435\u0434\u0435\u043d\u0438\u044f."}))}a=S8(this.Tb).trackData;var b=this.C;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==
b.languageName&&a.kind==b.kind:1)||(this.C=a,FXa(this,a));a=S8(this.Tb);-1===a.volume||Math.round(this.J.getVolume())===a.volume&&this.J.isMuted()===a.muted||this.X.isActive()||this.LO()}else EXa(this)};
g.k.RM=function(){this.J.ea("mdxpreviousnextchange")};
g.k.wA=function(){A9(this)||EXa(this)};
...
g.k.LO=function(){var a=this;if(A9(this)){var b=S8(this.Tb);this.events.qc(this.Z);b.muted?this.J.mute():this.J.unMute();this.J.setVolume(b.volume);this.Z=this.events.T(this.J,"onVolumeChange",function(c){DXa(a,c)})}};
...
g.k.Ub=function(a){this.B.stop();var b=this.I;if(!g.yJ(b,a)){var c=g.T(a,2);c!==g.T(this.I,2)&&this.J.Ht(c);this.I=a;HXa(this.u,b,a)}};g.w(D9,g.W);D9.prototype.Ad=function(){this.i.show()};
D9.prototype.Eb=function(){this.i.hide()};
D9.prototype.u=function(){T6("mdx-privacy-popup-cancel");this.Eb()};
D9.prototype.B=function(){T6("mdx-privacy-popup-confirm");this.Eb()};g.w(E9,g.W);E9.prototype.onStateChange=function(a){GXa(this,a.state)};g.w(F9,g.wP);F9.prototype.D=function(){var a=this.J.getOption("remote","receivers");a&&1<a.length&&!this.J.getOption("remote","quickCast")?(this.Ho=g.tc(a,this.i,this),g.xP(this,g.pn(a,this.i)),a=this.J.getOption("remote","currentReceiver"),a=this.i(a),this.options[a]&&this.Xh(a),this.enable(!0)):this.enable(!1)};
F9.prototype.i=function(a){return a.key};
F9.prototype.pj=function(a){return"cast-selector-receiver"===a?"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c":this.Ho[a].name};
...
g.k.create=function(){var a=this.player.V(),b=g.qE(a);a={device:"Desktop",app:"youtube-desktop",loadCastApiSetupScript:a.N("mdx_load_cast_api_bootstrap_script"),enableDialLoungeToken:a.N("enable_dial_short_lived_lounge_token"),enableCastLoungeToken:a.N("enable_cast_short_lived_lounge_token")};yXa(b,a);this.subscriptions.push(g.rv("yt-remote-before-disconnect",this.jU,this));this.subscriptions.push(g.rv("yt-remote-connection-change",this.JV,this));this.subscriptions.push(g.rv("yt-remote-receiver-availability-change",this.TM,
...
g.k.load=function(){this.player.cancelPlayback();g.FM.prototype.load.call(this);this.di=new z9(this,this.player,this.Tb);var a=(a=CXa())?a.currentTime:0;var b=w9()?new R8(q9(),void 0):null;0==a&&b&&(a=N8(S8(b)));0!==a&&this.Xb(a);HXa(this,this.Bd,this.Bd);this.player.bl(6)};
...
g.k.TM=function(){var a=[this.Tk],b=a.concat,c=zXa();F8()&&g.ry("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.Ho=b.call(a,c);a=r9()||this.Tk;I9(this,a);this.player.Oa("onMdxReceiversChange")};
